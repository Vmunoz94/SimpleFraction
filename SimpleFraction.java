...
public class SimpleFraction implements SimpleFractionInterface, Comparable<SimpleFraction>
{
	...
	public SimpleFraction(int num, int den)
	{
		...
		setSimpleFraction(num,den);	  // sends num and den to setSimpleFraction method
	...
	public void setSimpleFraction(int num, int den)
	{
		...
		this.num = num;	// creates access to this object num in toString method
		this.den = den; // creates access to this object num in toString method
		if (den ==  0) 
		{	
	...
	public double toDouble()
	{
		...
		return (double) num / den; 	//return 0.0;
	}	// end toDouble 
	...
	public SimpleFractionInterface add(SimpleFractionInterface secondFraction)
	{
		...
		SimpleFraction result = new SimpleFraction((num *((SimpleFraction)secondFraction).den) +
	               (den *((SimpleFraction)secondFraction).num),
	               den * ((SimpleFraction)secondFraction).den);
	...
	public SimpleFractionInterface multiply(SimpleFractionInterface secondFraction)
	{
		...
		// a/b * c/d is (ac)/(bd)
        // return result which is a new reduced SimpleFraction object
		SimpleFraction result = new SimpleFraction((num *((SimpleFraction)secondFraction).num),
	               den * ((SimpleFraction)secondFraction).den);
	       result.reduceSimpleFractionToLowestTerms();
	       return result;	//return null;
	}	// end multiply
	...
	{
		// implement this method!
		((SimpleFraction)other).reduceSimpleFractionToLowestTerms();
		return ((num == ((SimpleFraction)other).num && (den == ((SimpleFraction)other).den)));	//return false;
	} // end equals
	...
	private void reduceSimpleFractionToLowestTerms()
	{
		...
		if (num != 0) {
			...
			int GCD = GCD(num,den); //returns GCD
		
			num /= GCD; // implements GCD in num
			den /= GCD;	// implements GCD in den
		}
